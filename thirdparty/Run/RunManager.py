...
class RunManager():
    ...
    def end_epoch(self,dataset):
        ...
        loss = self.epoch_loss / len(self.dataset)
        accuracy = self.epoch_num_correct / len(self.dataset)
        ...
        results["epoch duration/s"] = epoch_duration
        results["run duration/s"] = run_duration
        results["Input_size"] =self.image_size
